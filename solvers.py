...
def solve_7b7f7511(I):
    x1 = is_portrait(I)
    x2 = branch(x1, top_half, left_half)
    O = x2(I)
    return O
...
def solve_662c240a(I):
    ...
    x2 = fork(equality, diagonal_mirror, identity)
    x3 = compose(flip, x2)
...
def solve_4347f46a(I):
    x1 = as_objects(I, True, False, True)
    x2 = fork(difference, to_indices, box)
    x3 = apply_and_merge(x2, x1)
    O = fill(I, ZERO, x3)
    return O
...
def solve_ce9e57f2(I):
    x1 = as_objects(I, True, False, True)
    x2 = fork(connect, upper_left_corner, centerofmass)
    x3 = apply_and_merge(x2, x1)
    x4 = fill(I, EIGHT, x3)
...
def solve_22eb0ac0(I):
    ...
    x2 = fork(recolor, color, backdrop)
    x3 = apply(x2, x1)
    x4 = mfilter(x3, is_horizontal_line)
    O = paint(I, x4)
    return O
...
def solve_d5d6de2d(I):
    x1 = as_objects(I, True, False, True)
    x2 = keep_if_condition(x1, square)
    x3 = difference(x1, x2)
...
def solve_dbc1a6ce(I):
    ...
    x4 = apply(x3, x2)
    x5 = fork(either, is_vertical_line, is_horizontal_line)
    x6 = mfilter(x4, x5)
...
def solve_40853293(I):
    ...
    x3 = apply(x2, x1)
    x4 = mfilter(x3, is_horizontal_line)
    x5 = mfilter(x3, is_vertical_line)
    x6 = paint(I, x4)
    O = paint(x6, x5)
    return O
...
def solve_5521c0d9(I):
    ...
    x5 = fork(shift_by_vector, identity, x4)
    x6 = apply_and_merge(x5, x1)
    O = paint(x3, x6)
    return O
...
def solve_810b9b61(I):
    ...
    x3 = fork(either, is_vertical_line, is_horizontal_line)
    x4 = keep_if_condition(x2, x3)
    x5 = difference(x2, x4)
...
def solve_fcc82909(I):
    ...
    x5 = fork(add, lower_right_corner, x4)
    x6 = fork(as_tuple, x3, x5)
    x7 = compose(box, x6)
...
def solve_72ca375d(I):
    ...
    x7 = pair(x4, x6)
    x8 = extract_first_matching(x7, last)
    O = first(x8)
    return O
...
def solve_253bf280(I):
    ...
    x6 = fork(either, is_vertical_line, is_horizontal_line)
    x7 = mfilter(x5, x6)
    x8 = fill(I, THREE, x7)
    O = fill(x8, EIGHT, x1)
    return O
...
def solve_1f642eb9(I):
    ...
    x7 = fork(shift_by_vector, identity, x6)
...
def solve_3ac3eb23(I):
    x1 = as_objects(I, True, False, True)
    x2 = chain(diagonal_neighbors, last, first)
...
def solve_8e5a5113(I):
    ...
    x8 = mpapply(shift_by_vector, x7, x6)
    O = paint(I, x8)
    return O
...
def solve_4be741c5(I):
    x1 = is_portrait(I)
    x2 = branch(x1, diagonal_mirror, identity)
...
def solve_2c608aff(I):
    ...
    x7 = fork(either, is_vertical_line, is_horizontal_line)
    x8 = mfilter(x6, x7)
    O = underfill(I, x1, x8)
    return O
...
def solve_83302e8f(I):
    x1 = as_objects(I, True, False, False)
    x2 = color_filter(x1, ZERO)
    x3 = keep_if_condition(x2, square)
    x4 = difference(x2, x3)
    x5 = merge(x3)
    x6 = recolor(THREE, x5)
    x7 = merge(x4)
...
def solve_178fcbfb(I):
    x1 = as_objects(I, True, False, True)
    x2 = of_color(I, TWO)
    x3 = apply_and_merge(vfrontier, x2)
    x4 = fill(I, TWO, x3)
...
def solve_1caeab9d(I):
    ...
    x6 = fork(shift_by_vector, identity, x5)
    x7 = merge(x1)
    x8 = cover(I, x7)
...
def solve_c8cbb738(I):
    ...
    x8 = fork(shift_by_vector, identity, x7)
    x9 = apply_and_merge(x8, x5)
    O = paint(x4, x9)
    return O
...
def solve_a85d4709(I):
    ...
    x4 = lbind(apply_and_merge, hfrontier)
    x5 = chain(x4, x3, x2)
    x6 = x5(ZERO)
    x7 = x5(TWO)
    x8 = x5(ONE)
...
def solve_beb8660c(I):
    ...
    x8 = apply(to_vertical_vec, x7)
    x9 = mpapply(shift_by_vector, x5, x8)
    x10 = canvas(ZERO, x1)
    x11 = paint(x10, x9)
    O = rot180(x11)
    return O
...
def solve_0962bcdd(I):
    ...
    x8 = fork(connect, upper_left_corner, lower_right_corner)
    x9 = fork(connect, lower_left_corner, upper_right_corner)
...
def solve_e73095fd(I):
    x1 = as_objects(I, True, False, False)
    x2 = color_filter(x1, ZERO)
    x3 = fork(equality, to_indices, backdrop)
    x4 = keep_if_condition(x2, x3)
...
def solve_97999447(I):
    ...
    x12 = prapply(shift_by_vector, x2, x11)
    x13 = merge(x12)
    O = fill(x7, FIVE, x13)
    return O
...
def solve_8e1813be(I):
    ...
    x5 = branch(x4, diagonal_mirror, identity)
    x6 = x5(x1)
...
def solve_75b8110e(I):
    ...
    x8 = fork(difference, as_indices, x7)
    x9 = fork(to_object, x8, identity)
    x10 = x9(x5)
    x11 = x9(x4)
    x12 = x9(x6)
    x13 = paint(x3, x12)
...
def solve_1a07d186(I):
    ...
    x11 = fork(shift_by_vector, identity, x10)
    x12 = apply_and_merge(x11, x7)
    x13 = merge(x2)
    x14 = cover(I, x13)
    O = paint(x14, x12)
...
def solve_9af7a82c(I):
    ...
    x10 = compose(x9, x7)
    x11 = fork(vertical_concat, x8, x10)
...
def solve_e26a3af2(I):
    ...
    x14 = branch(x9, vertical_upscale, horizontal_upscale)
    O = x14(x13, x11)
    return O
...
def solve_a87f7484(I):
    ...
    x3 = is_portrait(I)
    m4 = branch(x3, diagonal_mirror, identity)
    x5 = m4(I)
    x6 = decrement(x1)
...
def solve_4093f84a(I):
    ...
    x3 = of_color(I, FIVE)
    x4 = is_portrait(x3)
    m5 = branch(x4, identity, diagonal_mirror)
    x6 = m5(x2)
    x7 = left_half(x6)
    x8 = right_half(x6)
...
def solve_4612dd53(I):
    ...
    x4 = subgrid(x1, x3)
    x5 = of_color(x4, ONE)
    x6 = apply_and_merge(vfrontier, x5)
    x7 = apply_and_merge(hfrontier, x5)
    x8 = size(x6)
    x9 = size(x7)
...
def solve_ae3edfdc(I):
    ...
    x9 = x4(THREE)
    x10 = x4(SEVEN)
    x11 = fork(shift_by_vector, identity, x7)
    x12 = fork(shift_by_vector, identity, x8)
...
def solve_2204b7a8(I):
    ...
    x6 = is_greater(x4, x5)
    x7 = branch(x6, left_half, top_half)
    x8 = branch(x6, right_half, bottom_half)
    x9 = branch(x6, horizontal_concat, vertical_concat)
    x10 = x7(I)
    x11 = x8(I)
...
def solve_d9f24cd1(I):
    ...
    x4 = mfilter(x3, is_vertical_line)
    ...
    x15 = apply_and_merge(x14, x13)
    x16 = fill(x5, TWO, x15)
    x17 = apply_and_merge(vfrontier, x11)
    O = fill(x16, TWO, x17)
    return O
...
def solve_673ef223(I):
    ...
    x17 = apply_and_merge(hfrontier, x16)
...
def solve_e5062a87(I):
    ...
    x14 = chain(flip, x13, upper_left_corner)
...
def solve_846bdb03(I):
    ...
    x12 = other(x11, ZERO)
    x13 = equality(x8, x12)
    x14 = branch(x13, identity, vertical_mirror)
    x15 = x14(x4)
    x16 = normalize(x15)
...
def solve_5daaa586(I):
    ...
    x13 = mfilter(x12, is_vertical_line)
    x14 = mfilter(x12, is_horizontal_line)
    x15 = size(x13)
    x16 = size(x14)
...
def solve_3bdb4ada(I):
    ...
    x15 = compose(x14, x13)
    x16 = fork(keep_if_condition, first, x15)
    x17 = pair(x7, x8)
...
def solve_2bee17df(I):
    ...
    x10 = x9(I)
    x11 = pair(x4, x10)
    x12 = keep_if_condition(x11, last)
    x13 = apply_and_merge(hfrontier, x12)
    x14 = x9(x2)
    x15 = pair(x14, x4)
    x16 = keep_if_condition(x15, first)
    x17 = apply_and_merge(vfrontier, x16)
...
def solve_e8dc4411(I):
    ...
    x3 = of_color(I, x1)
    x4 = position(x2, x3)
    x5 = fork(connect, upper_left_corner, lower_right_corner)
    x6 = x5(x2)
...
def solve_29623171(I):
    ...
    x7 = compose(x6, first)
    x8 = compose(x6, last)
    x9 = fork(cartesian_product, x7, x8)
...
def solve_6cdd2623(I):
    ...
    x5 = merge(x4)
    x6 = cover(I, x5)
    x7 = fork(either, is_horizontal_line, is_vertical_line)
    x8 = box(x5)
...
def solve_8d510a79(I):
    ...
    x13 = compose(x12, x7)
    x14 = fork(keep_if_condition, x11, x13)
...
def solve_b190f7f5(I):
    x1 = is_portrait(I)
    x2 = branch(x1, vertical_split, horizontal_split)
    x3 = x2(I, TWO)
...
def solve_746b3537(I):
    ...
    x2 = x1(I)
    x3 = equality(x2, ONE)
    x4 = branch(x3, diagonal_mirror, identity)
    x5 = x4(I)
...
def solve_06df4c85(I):
    ...
    x18 = apply(x17, x13)
    x19 = fork(either, is_vertical_line, is_horizontal_line)
    x20 = mfilter(x18, x19)
    x21 = paint(I, x20)
    O = fill(x21, x2, x3)
    return O
...
def solve_eb5a1d5d(I):
    ...
    x6 = fork(vertical_concat, identity, x5)
    x7 = x6(x3)
...
def solve_0a938d79(I):
    ...
    x7 = x6(x5)
    x8 = compose(vfrontier, to_horizontal_vec)
...
def solve_99fa7670(I):
    ...
    x15 = remove(x10, x13)
    x16 = remove(x14, x13)
    x17 = compose(lower_right_corner, first)
    x18 = compose(lower_right_corner, last)
...
def solve_855e0971(I):
    ...
    x4 = size(x3)
    x6 = is_positive(x4)
    x7 = branch(x6, identity, diagonal_mirror)
    x8 = x7(I)
    x9 = rbind(subgrid, x8)
    ...
    x15 = lbind(apply_and_merge, vfrontier)
    x16 = chain(x15, x14, x9)
    x17 = fork(shift_by_vector, x16, upper_left_corner)
    x18 = fork(intersection, to_indices, x17)
...
def solve_6aa20dc0(I):
    ...
    x6 = fork(keep_if_condition, identity, x5)
    ...
    x21 = apply(x16, x20)
    x22 = rapply(x21, x3)
    x23 = fork(apply_and_merge, x18, x19)
...
def solve_e6721834(I):
    ...
    x20 = fork(shift_by_vector, identity, x19)
    x21 = apply(x20, x16)
...
def solve_447fd412(I):
    ...
    x21 = compose(x16, x20)
    x22 = fork(apply_and_merge, x17, x21)
    x23 = rapply(x10, x3)
...
def solve_776ffc46(I):
    x1 = as_objects(I, True, False, True)
    x2 = color_filter(x1, FIVE)
    x3 = fork(equality, to_indices, box)
...
def solve_36d67576(I):
    ...
    x15 = fork(apply_and_merge, x14, x13)
...
def solve_98cf29f8(I):
    ...
    x10 = chain(x8, diagonal_neighbors, last)
    x11 = chain(x7, x9, x10)
...
def solve_3befdf3e(I):
    ...
    x21 = fork(apply_and_merge, x18, x20)
...
def solve_9aec4887(I):
    ...
    x15 = fork(as_tuple, x14, identity)
    x16 = apply(x15, x7)
    x17 = paint(x4, x16)
    x18 = fork(connect, upper_left_corner, lower_right_corner)
    x19 = x18(x7)
    x20 = fork(combine, identity, vertical_mirror)
    x21 = x20(x19)
...
def solve_57aa92db(I):
    ...
    x21 = fork(subtract, upper_left_corner, x20)
...
def solve_f1cefba8(I):
    ...
    x25 = apply_and_merge(vfrontier, x23)
    x26 = apply_and_merge(hfrontier, x24)
    x27 = combine(x25, x26)
...
def solve_28e73c20(I):
    ...
    x27 = fork(vertical_concat, x24, rot90)
    x28 = fork(vertical_concat, x26, x27)
...
def solve_f8a8fe49(I):
    ...
    x4 = first(x3)
    x5 = is_portrait(x4)
    x6 = branch(x5, horizontal_split, vertical_split)
    x7 = branch(x5, vertical_mirror, horizontal_mirror)
    x8 = of_color(I, TWO)
    x9 = subgrid(x8, I)
    x10 = trim(x9)
    x11 = x7(x10)
    ...
    x22 = branch(x5, to_horizontal_vec, to_vertical_vec)
    x23 = x21(x15)
    x24 = double(x23)
...
def solve_0e206a2e(I):
    ...
    x21 = fork(apply_and_merge, x20, x19)
...
def solve_4290ef0e(I):
    ...
    x13 = fork(insert, diagonal_mirror, x12)
    x14 = fork(insert, counterdiagonal_mirror, x13)
    x15 = fork(insert, horizontal_mirror, x14)
    x16 = compose(x11, x15)
    x17 = apply(x16, x10)
    x18 = size(x2)
    x19 = apply(size, x2)
    ...
    x27 = pair(x26, x26)
    x28 = mpapply(shift_by_vector, x25, x27)
...
def solve_50846271(I):
    ...
    x25 = fork(combine, direct_neighbors, x24)
...
def solve_b527c5c6(I):
    ...
    x33 = compose(x29, x28)
    x34 = compose(x30, x28)
    x35 = fork(apply_and_merge, x32, x33)
    x36 = fork(apply_and_merge, x32, x34)
...
def solve_b7249182(I):
    ...
    x2 = merge(x1)
    x3 = is_portrait(x2)
    x4 = branch(x3, identity, diagonal_mirror)
    x5 = x4(I)
...
def solve_264363fd(I):
    ...
    x25 = compose(x23, x24)
    x26 = lbind(apply_and_merge, vfrontier)
    x27 = lbind(apply_and_merge, hfrontier)
    x28 = compose(x26, x25)
    x29 = compose(x27, x25)
    ...
    x37 = fork(shift_by_vector, x36, upper_left_corner)
...
def solve_7df24a62(I):
    ...
    x22 = compose(x21, x17)
    x23 = compose(x21, x19)
    x24 = fork(cartesian_product, x22, x23)
    ...
    x41 = apply(x40, x39)
    x42 = papply(keep_if_condition, x35, x41)
    x43 = apply(x27, x30)
    x44 = mpapply(apply_and_merge, x43, x42)
    O = fill(I, ONE, x44)
    return O
...
def solve_f15e1fac(I):
    x1 = of_color(I, TWO)
    x2 = is_portrait(x1)
    x3 = branch(x2, identity, diagonal_mirror)
    x4 = x3(I)
    x5 = leftmost(x1)
    x6 = equality(x5, ZERO)
    x7 = branch(x6, identity, vertical_mirror)
    x8 = x7(x4)
    x9 = of_color(x8, EIGHT)
    x10 = uppermost(x9)
    x11 = equality(x10, ZERO)
    x12 = branch(x11, identity, horizontal_mirror)
    x13 = x12(x8)
...
def solve_234bbc79(I):
    ...
    x11 = fork(keep_if_condition, identity, x9)
    x12 = fork(keep_if_condition, identity, x10)
    x13 = compose(direct_neighbors, last)
    x14 = rbind(chain, x13)
    x15 = lbind(x14, size)
    ...
    x29 = compose(x24, x27)
    x30 = fork(shift_by_vector, x28, x29)
    x31 = fork(combine, first, x30)
    x32 = fork(remove, x28, last)
    x33 = fork(as_tuple, x31, x32)
    x34 = size(x1)
    x35 = power(x33, x34)
    #x36 = as_tuple(x23, x6)
...
def solve_a64e4611(I):
    x1 = as_indices(I)
    x2 = fork(cartesian_product, identity, identity)
    x3 = lbind(canvas, ZERO)
    ...
    x20 = fork(apply_and_merge, x17, x19)
    x21 = multiply(2, 6)
...
def solve_a8c38be5(I):
    ...
    x26 = fork(shift_by_vector, identity, x25)
...
def solve_b775ac94(I):
    ...
    x32 = x30(x17)
    x33 = x30(x15)
    x34 = fork(shift_by_vector, x26, x31)
    x35 = fork(shift_by_vector, x27, x32)
    x36 = fork(shift_by_vector, x28, x33)
...
def solve_97a05b5b(I):
    ...
    x35 = fork(keep_if_condition, x31, x34)
    x36 = fork(apply, x19, x35)
    x37 = compose(x10, normalize)
    x38 = fork(apply_and_merge, x37, x36)
    ...
    x57 = fork(apply_and_merge, x37, x56)
...
def solve_3e980e27(I):
    ...
    x17 = x14(x9)
    x18 = x14(x10)
    x19 = fork(shift_by_vector, identity, x17)
    x20 = fork(shift_by_vector, identity, x18)
